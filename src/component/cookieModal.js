...
const CookieModal = () => {
  ...
  return (
    <div
      className="cookie-popup fixed max-w-lg bottom-3 end-3 start-3 sm:start-0 mx-auto bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md py-5 px-6 z-50"
      style={{ display: display ? "block" : "none" }}
    >
      <p className="text-slate-400">
        Este website utiliza cookies para aprimorar sua experiência. Ao acessar,
